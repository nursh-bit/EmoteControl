...
EmoteControl:RegisterPack({
  ...
  triggers = {
    ...
    {
      id = "mage_summon_table",
      event = "UNIT_SPELLCAST_SUCCEEDED",
      cooldown = 60,
      conditions = { class = "MAGE", unit = "player", spellID = 43987, spellName = "Ritual of Refreshment" },
      messages = {
    ...
    },
    {
      ...
      event = "UNIT_SPELLCAST_SUCCEEDED",
      cooldown = 60,
      conditions = { class = "MAGE", unit = "player", spellName = { "Portal:*", "Teleport:*" } },
      messages = {
